...
// ==================================================================================================================
// 메모 (artgine/server/html/Memo.html을 iframe으로 임베드)
// ==================================================================================================================
...
// F7 등 키보드로 탭을 전환하면 포커스가 부모 문서에 남아 있어 이후 Tab 키가 memo iframe(사이드바 토글)이 아니라
// 부모 페이지의 기본 포커스 이동으로 새어나간다. 탭이 보일 때마다 iframe에 포커스를 넘겨 이를 막는다.

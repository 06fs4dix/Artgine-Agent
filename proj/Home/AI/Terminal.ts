// Terminal auth client
// Talks to CTerminalRouter (/cmd/*)
...
const termScreen = document.getElementById('terminal-screen') as HTMLDivElement;
...
const ttydFrame  = document.getElementById('ttyd-frame') as HTMLIFrameElement;
...
function enterTerminal() {
    ...
    if (_mcpParam)        q.set('mcp', _mcpParam);
    if (_mdcopyParam)     q.set('mdcopy', _mdcopyParam);
